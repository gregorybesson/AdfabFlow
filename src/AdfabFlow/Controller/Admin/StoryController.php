...
use AdfabFlow\Entity\OpenGraphStory as Story;
...
class StoryController extends AbstractActionController
{
	...
	public function createAction()
	{
		...
		$viewModel->setTemplate('adfab-flow/admin/story/story');
	...
	public function getAdminStoryService()
	{
		if (!$this->adminStoryService) {
			$this->adminStoryService = $this->getServiceLocator()->get('adfabflow_story_service');
		}
