...
use AdfabFlow\Entity\OpenGraphAction as Action;
...
class ActionController extends AbstractActionController
{
	...
	public function createAction()
	{
		...
		$viewModel->setTemplate('adfab-flow/admin/action/action');
	...
	public function removeAction()
	{
		...
		if ($action) {
			try {
				...
				$this->flashMessenger()->setNamespace('adfabflow')->addMessage('The action has been removed');
			} catch (\Doctrine\DBAL\DBALException $e) {
				$this->flashMessenger()->setNamespace('adfabflow')->addMessage('This action is included in a story and can\'t be removed');
				//throw $e;
			}
		}
	...
	public function getAdminActionService()
	{
		if (!$this->adminActionService) {
			$this->adminActionService = $this->getServiceLocator()->get('adfabflow_action_service');
		}
