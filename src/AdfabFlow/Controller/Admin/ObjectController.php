...
use AdfabFlow\Entity\OpenGraphObject as Object;
use AdfabFlow\Entity\OpenGraphObjectAttribute as Attribute;
...
class ObjectController extends AbstractActionController
{
	...
	public function createAction()
	{
		...
		$viewModel->setTemplate('adfab-flow/admin/object/object');
	...
	public function removeAction()
	{
		...
		if ($object) {
			try {
				...
				$this->flashMessenger()->setNamespace('adfabflow')->addMessage('The object has been removed');
			} catch (\Doctrine\DBAL\DBALException $e) {
				$this->flashMessenger()->setNamespace('adfabflow')->addMessage('This object is included in a story and can\'t be removed');
				//throw $e;
			}
		}
	...
	public function getAdminObjectService()
	{
		if (!$this->adminObjectService) {
			$this->adminObjectService = $this->getServiceLocator()->get('adfabflow_object_service');
		}
