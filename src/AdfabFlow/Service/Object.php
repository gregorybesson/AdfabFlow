...
class Object extends EventProvider implements ServiceManagerAwareInterface
{
    ...
    {
    	$object  = new \AdfabFlow\Entity\OpenGraphObject();
    	$form  = $this->getServiceManager()->get('adfabflow_object_form');
    	$form->bind($object);
    	$form->setData($data);
    ...
    {
    	$attribute  = new \AdfabFlow\Entity\OpenGraphObjectAttribute();
    	$form  = $this->getServiceManager()->get('adfabflow_objectattribute_form');
    	$form->bind($attribute);
    	$form->setData($data);
    ...
    public function getObjectMapper()
    {
        if (null === $this->objectMapper) {
            $this->objectMapper = $this->getServiceManager()->get('adfabflow_object_mapper');
        }
    ...
    public function getObjectAttributeMapper()
    {
    	if (null === $this->objectAttributeMapper) {
    		$this->objectAttributeMapper = $this->getServiceManager()->get('adfabflow_objectattribute_mapper');
    	}
